...
const input = document.querySelector(".getSalary") as HTMLInputElement   
const destSalarySpan = document.querySelector(".span1") as HTMLSpanElement  
const destTaxSpan = document.querySelector(".span2") as HTMLSpanElement 
const spanInfoPercentage  =  document.querySelector("#spanInfoPercentage") as HTMLSpanElement
...
const calculateSalaryAfterTax = (salaryBeforeTax: number) => {   
    let totalTax: number = 0
    let salaryAfterTax: number = 0
 ...
 const showResult = (taxValue: number, endSalaryValue: number, taxPercentage: number) => {   
...
const btnClearForm = document.querySelector(".btnClear") as HTMLButtonElement
...
const changeSpanInfo = (sString: string) => {
    document.querySelectorAll(".wordShek").forEach ((spanElement ) => {       
        spanElement.textContent = sString  
     })  
}

const changeHeaderInfo = (el: any, sStr: string) => {
   const head = document.querySelector(el) as HTMLHeadElement 
